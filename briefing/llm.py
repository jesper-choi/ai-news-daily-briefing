...
# 최신 3.8을 1티어에 단독으로 두어 하루 20콜은 전부 3.8이 맡고, 남는 2콜과 3.8이
# 과부하(503)일 때만 아래 티어로 내려간다. 새 모델이 나오면 1티어를 그것으로 바꾸고
# 직전 모델은 2티어로 내린다 - 그만큼 폴백이 두터워진다.
MODEL_TIERS = [
    [("gemini-3.8-flash", 12)],                                    # RPD 20, RPM 5
    [("gemini-3.7-flash", 12), ("gemini-3.6-flash", 12),
     ("gemini-3.5-flash", 12)],                                    # RPD 20씩, RPM 5
